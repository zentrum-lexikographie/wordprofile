                        ...
                        if vCollapsRule[i].strHeadCat in vDepNode[j].mapCat:
                            ...
                            if vCollapsRule[i].strDirection == 'left' and j > 0:
                                if vCollapsRule[i].strDepCat in vDepNode[j - 1].mapCat and not vDepNode[j - 1].bUsed:
                                    ...
                                    if vCollapsRule[i].bDepTerminal == (vDepNode[j - 1].vChild == []) or vCollapsRule[
                                        i].bDepTerminal == None:
                                        ...
                                        vDepNode[j - 1].mapCat = {vCollapsRule[i].strDepCat: vDepNode[j - 1].mapCat[
                                            vCollapsRule[i].strDepCat]}
                                        vDepNode[j].mapCat = {
                                            vCollapsRule[i].strHeadCat: vDepNode[j].mapCat[vCollapsRule[i].strHeadCat]}
