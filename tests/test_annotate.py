...
def test_deduce_case_caseless_subject_active():
    sent = [
        conllu.Token(
            id=1,
            form="Der",
    ...
    assert anno.deduce_case(sent, 2) == "Nom"


def test_deduce_case_caseless_subject_passive():
    sent = [
        conllu.Token(
            id=1,
            form="Mit",
    ...
    assert anno.deduce_case(sent, 6) == "Nom"


def test_deduce_case_via_determiner():
    sent = [
        conllu.Token(
            id=1,
            form="Mit",
    ...
    assert anno.deduce_case(sent, 3) == "Dat"


def test_deduce_case_via_preposition():
    sent = [
        conllu.Token(
            id=1,
            form="Mit",
...
def test_deduce_case_via_amod():
    ...
    assert anno.deduce_case(sent, 5) == "Acc"


def test_lemmatization_makes_use_of_indirect_case_marking(lemmatizer):
    sent_without_morph = [
        conllu.Token(
            id=1,
            form="Sie",
    ...
    anno.lemmatize(lemmatizer, sent_without_morph)
